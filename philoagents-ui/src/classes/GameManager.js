...
export class GameManager {
    ...
    async fetchAndProcessGameState() {
        ...
        try {
            ...
            this.events.emit('showCrisisUpdate', this.gameState.crisis_update, this.gameState.round_number);
    ...
    async submitPlayerAction(actionData) {
        ...
        try {
            ...
            console.log("GameManager: Action submitted successfully. Waiting for next round...");
