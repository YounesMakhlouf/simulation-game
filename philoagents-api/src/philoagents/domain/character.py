...
class Character(BaseModel):
    ...
    id: str = Field(
        description="Unique identifier for the character (e.g., 'hannibal_barca')."
    )
    name: str = Field(
        description="The full name of the historical figure (e.g., 'Hannibal Barca')."
    )
    ...
    victory_points: int = Field(
        default=0,
        description="The character's current score towards a Factional Supremacy victory.",
    )
