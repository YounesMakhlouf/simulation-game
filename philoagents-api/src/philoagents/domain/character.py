...
class CharacterExtract(BaseModel):
    ...
    id: str = Field(description="A unique, machine-readable identifier for the character (e.g., 'hanno_the_great').")
    urls: List[str] = Field(
...
class Character(BaseModel):
    ...
    id: str = Field(description="Unique identifier for the character (e.g., 'hannibal_barca').")
    name: str = Field(description="The full name of the historical figure (e.g., 'Hannibal Barca').")
