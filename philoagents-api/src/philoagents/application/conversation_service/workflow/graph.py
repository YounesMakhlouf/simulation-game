...
from philoagents.application.conversation_service.workflow.nodes import (conversation_node, summarize_conversation_node,
                                                                         retriever_node, summarize_context_node,
                                                                         connector_node, )
...
def create_workflow_graph():
    ...
    graph_builder.add_node("retrieve_character_context", retriever_node)
