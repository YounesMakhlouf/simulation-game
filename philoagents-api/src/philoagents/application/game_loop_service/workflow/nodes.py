...
from philoagents.application.game_loop_service.workflow.chains import (get_character_action_chain,
...
def _apply_resource_updates(characters: Dict[str, Character], updated_resources: List[UpdatedResource]) -> Dict[
    str, Character]:
    """
